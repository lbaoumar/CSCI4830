...
@WebServlet("/MyServletHibernateDBbaoumar")
public class MyServletHibernateDBbaoumar extends HttpServlet {
   private static final long serialVersionUID = 1L;

   public MyServletHibernateDBbaoumar() {
      super();
   }
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      // #1
     // UtilDBbaoumar.createStudents("Lloyd", "Baoumar", "72879018", "lb@uno.edu");
   ...
   void retrieveDisplayData(PrintWriter out) {
      String title = "Students in Database Result";
      ...
      out.println("<ul>");
      List<Student> listEmployees = UtilDBbaoumar.listStudents();
